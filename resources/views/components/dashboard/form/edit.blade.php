<div x-data="app">
    ...
    <div class="mb-8">
        ...
        <h1 class="font-serif text-2xl font-semibold text-[#1d1d1f]">Edit {{ $title }}</h1>
    </div>

    <form method="POST" action="/dashboard/berita" class="max-w-3xl" @submit.prevent="submitArticleLeader()">
        @csrf
        
        {{-- Title --}}
        <div class="mb-6">
            <label class="mb-2 block text-sm font-medium text-[#1d1d1f]">{{ $title }}</label>
        ...
        <div class="mb-8">
            ...
            <textarea name="content" id="editContentEditor" cols="30" rows="10"
    ...
    const app = {
        ...
        async submitArticleLeader() {
            ...
            await axios.put('{{ $url }}' + '/' + {{ $data->id }}, {
                ...
                .then(r => {
                    this.$dispatch('notice', { type: 'success', text: '✔️ Data Berhasil Disimpan' });
                    setTimeout(() => {
