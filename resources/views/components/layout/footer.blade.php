<div class="border-t-[0.5px] border-solid border-black/10 my-20 ">
    <div class="container mx-auto max-w-7xl md:flex md:justify-between">
        ...
        <div class="mt-14 p-10 flex justify-center gap-1">
            <a href="https://www.facebook.com/darussalamblokagung2"
                class="border-[0.5px] text-gray-400 hover:text-blue-800 border-solid hover:border-black/30 transition-all hover:shadow border-black/10 h-10 w-10 flex items-center justify-center rounded-full cursor-pointer"><ion-icon
