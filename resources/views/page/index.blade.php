...
@section('content')
    <div class="container mx-auto mt-5 px-2 -z-10">
            ...
            <div class="w-full max-w-7xl mx-auto">
                <div class="relative grid md:grid-cols-3 gap-2 pt-4">
                    @foreach ($berita as $item)
                        <div class="relative overflow-hidden last:ptablet:hidden rounded-lg">
                            <div class="relative">
                            ...
                            <div class="absolute top-0 left-0 w-full h-full z-20 flex flex-col justify-end">
                                <div class="p-6 bg-gradient-to-b from-transparent to-slate-900 ">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <span class="flex items-center gap-2">
                                                <div
                                                    class="h-7 w-7 flex items-center justify-center shrink-0 rounded-full bg-white ">
                                                    <img src="https://i.pinimg.com/236x/8e/0c/fa/8e0cfaf58709f7e626973f0b00d033d0.jpg"
                                                        alt="Clark Smith"
                                                        class="h-7 w-7 rounded-full object-cover scale-90">
                                                </div>
                                                <div>
        ...
        <div class="px-6 my-16">
            <div class="my-20">
                <h1 class="text-center text-4xl font-normal text-gray-700 md:text-5xl">Visi & Misi Yayasan</h1>
                <p class="text-center text-xs text-gray-500 mb-7 mt-2 max-w-md mx-auto">Visi dan misi adalah dua elemen
                    penting
                    dalam
                    perencanaan
            ...
            <div class="bg-gradient-to-b from-blue-600/20 py-5 px-2 rounded-[40px]">
                <h1 class="text-center text-4xl font-normal text-gray-700 md:text-5xl">Visi</h1>
                <p class="text-center mt-2 text-xs max-sm:text-center text-gray-600 mb-10">
                    Terwujudnya santri yang bertaqwa, Kuat & Mandiri.
                </p>
                <div class="swiper">
                    <div class="swiper-wrapper">
                        <div
                            class="p-8 rounded-[40px] border-2 border-white shadow-inner bg-gradient-to-t from-gray-100 bg-white swiper-slide max-w-sm">
                            <h4 class="text-center">
                                Bertaqwa
                            </h4>
                            <p class="text-xs text-gray-500 mt-4 leading-relaxed tracking-wider">
                                Visi ini menunjukkan bahwa yayasan atau pesantren memiliki tujuan untuk membentuk santri
                                yang memiliki keberagamaan yang kuat. Santri diharapkan memiliki pemahaman yang baik tentang
                                ajaran agama dan mampu mengamalkannya dalam kehidupan sehari-hari. Mereka diharapkan menjadi
                                individu yang memiliki kesadaran spiritual yang tinggi dan berkomitmen untuk menjalankan
                        ...
                        <div
                            ...
                            <p class="text-xs text-gray-500 mt-4 leading-relaxed tracking-wider">
                                Visi ini menggambarkan bahwa yayasan atau pesantren ingin melahirkan santri yang kuat, baik
                                secara fisik maupun mental. Santri diharapkan memiliki kesehatan fisik yang baik dan mampu
                        ...
                        <div
                            ...
                            <p class="text-xs text-gray-500 mt-4 leading-relaxed tracking-wider">
                                Visi ini menunjukkan bahwa yayasan atau pesantren ingin menghasilkan santri yang mandiri.
                                Santri diharapkan memiliki kemampuan untuk mengambil keputusan secara bijaksana, mengelola
                                waktu dengan baik, dan memiliki kemandirian dalam menjalankan kegiatan sehari-hari. Mereka
                                diharapkan dapat mengembangkan potensi diri, memiliki keterampilan yang relevan, dan siap
            ...
            <div class="my-20 h-60">
                <h1 class="text-center text-4xl font-normal text-gray-700 md:text-5xl mb-10">Misi</h1>
                <h1 class="text-center text-4xl font-normal text-gray-700 md:text-2xl">
                    <span class="typer" id="main"
                        data-words="Memberikan bekal Agama yang kuat,Meningkatkan Kualitas sumber daya menusia seutuhnya,Mencetak generasi muda yang berkualitas dalam agama dan pengetahuan umum,Memberi bekal dengan keterampilan, keagamaan, sosial, dan teknologi"
            ...
            <div
                class="max-w-7xl px-6 my-16 mx-auto relative flex flex-col md:flex-row items-center justify-between gap-y-4">
