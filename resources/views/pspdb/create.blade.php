...
@section('content')
    ...
    @endif
    <form class="mt-5" action="/pspdb" method="POST">
        @csrf
        ...
        <div class="relative z-0 w-full mb-5 group ">
            <input type="text"" name="asal_sklh" id="asal_sklh"
                ...
                placeholder=" " />
            <label for="asal_sklh"
                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Asal
                Sekolah</label>
        </div>
        <div class="relative z-0 w-full mb-5 group ">
        ...
        <button type="submit"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center gap-2"><ion-icon
                name="caret-forward-outline"></ion-icon> Selanjutnya</button>
    </form>
